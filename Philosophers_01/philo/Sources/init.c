...
/*   Updated: 2025/04/07 14:28:07 by rvikrama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((argc == 6 && data->meals_sum < 0) || (data->philo_sum < 1)
		|| (data->philo_sum > 200) || (data->death_time < 60)
		|| (data->feasting_time < 60) || (data->sleeping_time < 60))
	{
		print_error(1);
	}
